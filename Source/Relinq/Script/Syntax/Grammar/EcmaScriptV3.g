...
Copyrights 2008 Xebic Research BV. All rights reserved (see license.txt).
...
@lexer::namespace{ Relinq.Script.Syntax.Grammar }
@parser::namespace{ Relinq.Script.Syntax.Grammar }
...
{
	throw Relinq.Exceptions.JSToCSharp.Parser.RecognitionExceptionHelper.Report(this, e);
}
}
...
DecimalFloatingPointLiteral
	: DecimalIntegerPart '.' DecimalDigit* ExponentPart?
	| '.' DecimalDigit+ ExponentPart?
	| DecimalIntegerPart ExponentPart
	;
